-- SoulLink Tracker — Migration v5
-- Ausführen in: Supabase Dashboard → SQL Editor → Paste → Run

-- Extend request_type constraint to include 'team_remove' and 'team_move'
DO $$
...
ALTER TABLE link_requests
  ...
  CHECK (request_type IN ('link', 'death', 'team_sync', 'team_remove', 'team_move'));
