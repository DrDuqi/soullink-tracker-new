...
import { LayoutDashboard, Users, Settings, BookOpen, Swords, Backpack, Grid3x3, Sparkles } from 'lucide-react'
...
export const NAV: NavItem[] = [
  ...
  { id: 'abilities', label: 'Fähigkeiten',   icon: Sparkles,        to: '/abilities' },
